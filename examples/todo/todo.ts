...
// prettier-ignore
export const $schema = {models:{Todo:{type:'Struct',fields:{id:{type:'Reference',name:'UUID'},title:{type:'String'},createdAt:{type:'Reference',name:'Instant'},checkedAt:{type:'Nullable',inner:{type:'Reference',name:'Instant'}}}},UpdateTodoParams:{type:'Struct',fields:{title:{type:'Nullable',inner:{type:'String'}}}},Instant:{type:'External',inner:{type:'String'}},CreateTodoParams:{type:'Struct',fields:{title:{type:'String'}}},UUID:{type:'Alias',inner:{type:'String'}}},services:{TodoService:{type:'Service',methods:{create:{inputs:{params:{type:'Reference',name:'CreateTodoParams'}},output:{type:'Reference',name:'Todo'}},get:{inputs:{id:{type:'Reference',name:'UUID'}},output:{type:'Reference',name:'Todo'}},getAll:{inputs:{},output:{type:'List',inner:{type:'Reference',name:'Todo'}}},update:{inputs:{id:{type:'Reference',name:'UUID'},params:{type:'Reference',name:'UpdateTodoParams'}},output:{type:'Reference',name:'Todo'}},delete:{inputs:{id:{type:'Reference',name:'UUID'}},output:{type:'Unit'}}}}}} as const;